...
export class WorldMap {
  ...
  constructor() {
    ...
    this.zones = [
      ...
      { id: 'tunnels', title: 'Serpent Tunnels', min: v(-150, -16.4, -320), max: v(160, -4, -150), interior: true, visibleFrom: ['moon', 'library'], fog: { color: 0x070c14, density: 0.03 }, ambient: { color: 0x4c5c6c, intensity: 2.4 }, extra: [{ min: v(-124, -16, -250), max: v(-98, -4, -131) }], priority: 1, build: buildTunnels },
